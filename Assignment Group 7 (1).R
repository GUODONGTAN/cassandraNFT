...
shinyData <- read.csv("~/R Studio/GroupProject/shinyData.csv")
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "dashboard",
              fluidRow(
                box(
                  title = "CryptoPunk 1482",status = "primary", solidHeader = TRUE, width = 5, height = 700,
                  collapsible = TRUE,
                  fluidRow(
                    tabBox(
                      title = "Details",
                      ...
                      tabPanel("Profile", img(src=imageData[1], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      tabPanel("Profile",img(src=imageData[2], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      tabPanel("Profile", img(src=imageData[3], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      # The id lets us use input$tabset1 on the server to find the current tab
                      id = "tabset1", height = "250px",
                      tabPanel("Profile",img(src=imageData[4], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      # The id lets us use input$tabset1 on the server to find the current tab
                      id = "tabset1", height = "250px",
                      tabPanel("Profile",img(src=imageData[5], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      # The id lets us use input$tabset1 on the server to find the current tab
                      id = "tabset1", height = "250px",
                      tabPanel("Profile",img(src=imageData[6], width = "150px")),
                ...
                box(
                  ...
                  fluidRow(
                    tabBox(
                      ...
                      # The id lets us use input$tabset1 on the server to find the current tab
                      id = "tabset1", height = "250px",
                      tabPanel("Profile", img(src=imageData[7])),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[8], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[9], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[10], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[11], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[12], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[13], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile",img(src=imageData[14], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[15], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[16], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[17], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile",img(src=imageData[18], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[19], width = "150px")),
              ...
              box(
                ...
                fluidRow(
                  tabBox(
                    ...
                    # The id lets us use input$tabset1 on the server to find the current tab
                    id = "tabset1", height = "250px",
                    tabPanel("Profile", img(src=imageData[20], width = "150px")),
...
server <- function(input, output) {
  ...
  output$img1 <- renderImage({
    list(src = "https://www.larvalabs.com/public/images/cryptopunks/punk0441.png
", height = "300px", width = "300px", alt = "Something went wrong", deleteFile = FALSE)
  })
