      ...
      tabItem(tabName = "homepage",
              ...
              fluidRow(
                ...
                box(title = "Historical Price", status = "primary", width = 12, solidHeader =TRUE,
                    plotOutput("plot1")),
                column(width = 6,
                       infoBox(title = "Mean", width = NULL,color = "maroon", icon = icon("dollar-sign"),
                               textOutput('mean'))),
                column(width = 6,
                       infoBox(title = "Standard Deviation", width = NULL, color = "aqua",
                               icon = icon("dollar-sign"), textOutput('std'))
                  )
                ) 
              ),
